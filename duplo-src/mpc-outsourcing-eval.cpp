...
int main(int argc, const char* argv[]) {
    ...
    opt.overview = "MPCOutsourcingEvaluator Passing Parameters Guide.";
    opt.syntax = "MPCOutsourcingEvaluator first second third forth fifth sixth";
    opt.example = "MPCOutsourcingEvaluator -c outsc -e 1,1,1 -ip localhost -p 28001 -a 1 -t 1\n\n";
...
//    Run Preprocessing phase
    ...
    if (num_aes_in_composed != 0)
        duplo_eval.PreprocessComponentType(circuit_name_aes, circuit_aes, num_aes_in_composed, num_execs_components);
...
//    PrintBin(eval_outputs[0].data(), 128); /*Print input*/
//    PrintBin(eval_outputs[1].data(), 128); /*Print output*/
//
...
//    PrintBin(res, 128);
    ...
    ofstream timing_file ("eval.timing", ios::out | ios::app);
